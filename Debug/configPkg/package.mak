...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccs900/ccs/tools/compiler/ti-cgt-arm_18.12.1.LTS
...
.dlls,em3 .dlls: adcBufContinuousSampling.pem3

-include package/cfg/adcBufContinuousSampling_pem3.mak
-include package/cfg/adcBufContinuousSampling_pem3.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/adcBufContinuousSampling_pem3.dep
endif
adcBufContinuousSampling.pem3: package/cfg/adcBufContinuousSampling_pem3.xdl
	@


ifeq (,$(wildcard .libraries,em3))
adcBufContinuousSampling.pem3 package/cfg/adcBufContinuousSampling_pem3.c: .libraries,em3
endif

package/cfg/adcBufContinuousSampling_pem3.c package/cfg/adcBufContinuousSampling_pem3.h package/cfg/adcBufContinuousSampling_pem3.xdl: override _PROG_NAME := adcBufContinuousSampling.xem3
package/cfg/adcBufContinuousSampling_pem3.c: package/cfg/adcBufContinuousSampling_pem3.cfg
package/cfg/adcBufContinuousSampling_pem3.xdc.inc: package/cfg/adcBufContinuousSampling_pem3.xdl
package/cfg/adcBufContinuousSampling_pem3.xdl package/cfg/adcBufContinuousSampling_pem3.c: .interfaces

clean:: clean,em3
	-$(RM) package/cfg/adcBufContinuousSampling_pem3.cfg
	-$(RM) package/cfg/adcBufContinuousSampling_pem3.dep
	-$(RM) package/cfg/adcBufContinuousSampling_pem3.c
	-$(RM) package/cfg/adcBufContinuousSampling_pem3.xdc.inc

clean,em3::
	-$(RM) adcBufContinuousSampling.pem3
.executables,em3 .executables: adcBufContinuousSampling.xem3

adcBufContinuousSampling.xem3: |adcBufContinuousSampling.pem3

-include package/cfg/adcBufContinuousSampling.xem3.mak
adcBufContinuousSampling.xem3: package/cfg/adcBufContinuousSampling_pem3.oem3 
	$(RM) $@
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M3 -z --strict_compatibility=on  -o $@ package/cfg/adcBufContinuousSampling_pem3.oem3   package/cfg/adcBufContinuousSampling_pem3.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
	
adcBufContinuousSampling.xem3: export C_DIR=
adcBufContinuousSampling.xem3: PATH:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)
adcBufContinuousSampling.xem3: Path:=$(ti.targets.arm.elf.M3.rootDir)/bin/;$(PATH)

adcBufContinuousSampling.test test,em3 test: adcBufContinuousSampling.xem3.test

adcBufContinuousSampling.xem3.test:: adcBufContinuousSampling.xem3
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 adcBufContinuousSampling.xem3.test
else
	@$(MSG) running $<  ...
	$(call EXEC.adcBufContinuousSampling.xem3, ) 
endif

clean,em3::
	-$(RM) $(wildcard .tmp,adcBufContinuousSampling.xem3,*)


clean:: clean,em3

clean,em3::
	-$(RM) adcBufContinuousSampling.xem3
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
adcBufContinuousSampling_pem3.oem3,copy : package/cfg/adcBufContinuousSampling_pem3.oem3
adcBufContinuousSampling_pem3.sem3,copy : package/cfg/adcBufContinuousSampling_pem3.sem3
